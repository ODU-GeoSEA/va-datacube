...
<img align="centre" src="supplementary_files/GeoSEA_MainPage.jpg" width="100%">
...
The Virginia (VA) Data Cube Notebooks repository (`va-datacube`) hosts Jupyter Notebooks, Python scripts and workflows for analysing Virginia satellite data and derived products. This documentation is designed to provide a guide to getting started with the Virginia Data Cube, and to showcase the wide range of geospatial analyses that can be achieved using VA Data Cube data and open-source software including [Open Data Cube](https://www.opendatacube.org/) and [xarray](http://xarray.pydata.org/en/stable/).
